...
module.exports = function(RED) {
                ...
                if (this.useSpawn === true) {
                    ...
                    child.stdout.on('data', function (data) {
                        if (node.activeProcesses.hasOwnProperty(child.pid) && node.activeProcesses[child.pid] !== null) {
                            // console.log('[provanodo] stdout: ' + data,child.pid);
                    ...
                    child = exec(cl, {encoding:'binary', maxBuffer:10000000}, function (error, stdout, stderr) {
                        ...
                        node.status({});
                        //console.log('[provanodo] stdout: ' + stdout);
                        //console.log('[provanodo] stderr: ' + stderr);
                        if (error !== null) {
    ...
    RED.nodes.registerType("provanodo",ExecNode);
}
